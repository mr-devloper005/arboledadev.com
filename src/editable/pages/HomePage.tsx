...
import {
  EditableCollectionsGrid,
  EditableFaqSection,
  EditableFeaturedAndStats,
  EditableHomeCta,
  EditableHomeHero,
...
export default async function HomePage() {
  // Pick the first UI-visible enabled task (skips hidden tasks like `profile`).
  ...
  return (
    <EditableSiteShell>
      <main>
        ...
        <div className="mx-auto w-full max-w-[var(--editable-container)] px-5 pt-8 sm:px-8 lg:px-12">
        ...
        <EditableCollectionsGrid />
        <EditableFeaturedAndStats primaryTask={primaryTask} primaryRoute={primaryRoute} posts={primaryPosts} timeSections={timeSections} />
